    ...
    return (
        ...
        <AuroraBackground>
            <motion.div
                ...
                className="bg-gray-800/20 min-h-screen min-w-screen relative flex flex-col "
            >
                {/* Navbar */}
                <RegularNavBar
                ...
                <div className="text-center space-y-8 p-16">
                    <h1 className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-700">
                    ...
                    <Button
                        ...
                        className="relative group overflow-hidden px-8 py-6 text-lg font-semibold rounded-lg bg-gradient-to-r from-blue-500 to-purple-700 text-white hover:from-blue-700 hover:to-purple-900 transition-all duration-300"
                    >
