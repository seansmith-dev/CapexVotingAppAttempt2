    ...
    return (
        ...
        <div className="footer">
            <div className="footer-header">
                <Logo size="footer" />
                <div className="footer-header__socials-container">
                    <p className="footer-header__text">Connect With Swinburne</p>
                    <div className="footer-header__social-tag-container">
            ...
            <div className="footer-nav">
                <ul className="footer-nav__list">
                    ...
                    <li className="footer__item">
                        <Link to="/projects-list" className="footer-link">Vote</Link>
                    </li>
                    <li className="footer__item">
                        <Link to="/navigation-assistant" className="footer-link">Directions</Link>
                    </li>
                    <li className="footer__item">
                        <Link to="/projects-list" className="footer-link">Projects List</Link>
                    </li>
                    <li className="footer__item">
